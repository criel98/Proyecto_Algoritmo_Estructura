...
import package_clase.GestorPaciente;
...
public class From_Registro_Cliente extends javax.swing.JFrame {
    ...
    private GestorPaciente gestorPacientes = new GestorPaciente();
    ...
    private void cargarTablaDesdeGestor() {
        modeloTabla.setRowCount(0); // Limpiamos las filas visuales actuales

        // Recorremos la lista que el gestor cargó de forma transparente
        for (Paciente p : gestorPacientes.obtenerPacientes()) { // Ajustado a obtenerPacientes() o el getter del gestor
            ...
            // Insertamos al inicio para mantener el formato original
    ...
    private void initComponents() {
        ...
        jLabel3.setForeground(new java.awt.Color(22, 30, 64));
        ...
        jLabel2.setForeground(new java.awt.Color(22, 30, 64));
        jLabel2.setText("Apellido Paterno :");

        jLabel1.setForeground(new java.awt.Color(22, 30, 64));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        // Creamos la instancia del objeto Paciente
        Paciente nuevoPaciente = new Paciente(tipoDoc, numDoc, nombre, apPaterno, apMaterno, fechaNac, genero, telefono);

        // REFACTORIZADO: Añadimos a través del gestor (guarda en CSV automáticamente)
        gestorPacientes.agregarPaciente(nuevoPaciente);

        // Actualizamos la tabla visual volviendo a leer el gestor ordenadamente
        cargarTablaDesdeGestor();
    ...
    private void txtFechaNacimKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtFechaNacimKeyReleased
        String fechaTexto = txtFechaNacim.getText().trim();
            ...
            if (edadCalculada >= 0 && edadCalculada < 130) {
                ...
                txtEdad.setText(""); // Si la fecha es del futuro o incoherente
            }
        } else {
            txtEdad.setText(""); // Limpia la edad si borran caracteres
        }
